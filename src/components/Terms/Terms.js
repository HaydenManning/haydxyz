...
const Terms = () => (
  <div className="terms">
    <h1>HDN Terms of Service</h1>
    <p>
      By accessing the website at <a href="http://www.hdn.mx/">hdn.mx</a>, you
    ...
    <p>
      In no event shall HDN or its suppliers be liable for any damages
      ...
      materials on {"HDN's"} website, even if HDN or a HDN authorized
    ...
    <p>
      The materials appearing on HDN website could include technical,
      typographical, or photographic errors. HDN does not warrant that any of
      the materials on its website are accurate, complete or current. HDN may
      make changes to the materials contained on its website at any time without
      notice. However HDN does not make any commitment to update the materials.
    </p>
    <p>
      HDN has not reviewed all of the sites linked to its website and is not
      responsible for the contents of any such linked site. The inclusion of any
      link does not imply endorsement by HDN of the site. Use of any such linked
      website is at the {"user's"} own risk.
    </p>
    <p>
      HDN may revise these terms of service for its website at any time without
